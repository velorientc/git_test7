...
#        self.revdisplay.commitsignal.connect(self.commit)
    ...
    def setupUi(self):
        ...
        self.revisiondetails_frame = QtGui.QFrame(self.revisions_splitter)
        sp = SP(SP.Preferred, SP.Expanding)
        sp.setHorizontalStretch(0)
        sp.setVerticalStretch(0)
        sp.setHeightForWidth(self.revisiondetails_frame.sizePolicy().hasHeightForWidth())
        self.revisiondetails_frame.setSizePolicy(sp)
