...
class SynchDialog(gtk.Window):
    def __init__(self, cwd='', root = '', repos=[]):
        ...
        revvbox = gtk.VBox()
        revhbox = gtk.HBox()
        revhbox.pack_start(gtk.Label('Rev:'), False, False, 2)
        revhbox.pack_start(self._reventry, False, False, 2)
        revvbox.pack_start(revhbox)
        revvbox.pack_start(self._force, False, False, 2)
        hbox.pack_start(revvbox, False, False, 2)
